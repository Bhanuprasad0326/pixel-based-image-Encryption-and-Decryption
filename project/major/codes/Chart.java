...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(SVM.acc,"SVM Accuracy","SVM Accuracy");
	localDefaultCategoryDataset.addValue(KNN.acc,"KNN Accuracy","KNN Accuracy");
	localDefaultCategoryDataset.addValue(NaiveBayesAlg.acc,"Naive Bayes Accuracy","Naive Bayes Accuracy");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Algorithm Name", "Accuracy", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
